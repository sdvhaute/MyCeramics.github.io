const getAllProjects =
  "SELECT * , experimental_strftime(startdate::date, '%Y-%m-%d') startdate, experimental_strftime(throwndate::date, '%Y-%m-%d') throwndate, experimental_strftime(trimmeddate::date, '%Y-%m-%d') trimmeddate, experimental_strftime(bisquedate::date, '%Y-%m-%d') bisquedate, experimental_strftime(glazeddate::date, '%Y-%m-%d') glazeddate, experimental_strftime(glazefireddate::date, '%Y-%m-%d') glazefireddate FROM projects2 where user_id=$1 ORDER BY projectname";
